...
<div class="bloghome">
    ...
    <div class="wrapper-slider-blog-home">
      <div class="swiper-button-prev"></div>
      <div class="bloghome mt-2 swiper" data-swiper='{block name="blog_home_slider_options"}{$sliderConfig|json_encode}{/block}'>
        {assign var=counter value=1}
        <div class="swiper-wrapper ">
          {foreach from=$everpsblog item=item}
            <div class="article everpsblog swiper-slide" id="everpsblog-{$item->id_ever_post|escape:'htmlall':'UTF-8'}">
    ...
    <div class="text-center">
        <a href="{$blogUrl|escape:'htmlall':'UTF-8'}" title="{l s='See all posts from the blog' mod='everpsblog'}" class="btn btn-secondary">{l s='See all posts from the blog' mod='everpsblog'}</a>
    </div>
</div>
